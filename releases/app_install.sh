...
# Списки пакетов
APT_PACKAGES="python3-venv python3-pip curl git ffmpeg libsndfile1 portaudio19-dev yad libqt6webengine6 libqt6gui6 libegl1 libgl1 libxkbcommon0 libxcb-xinerama0 libxcb-cursor0"
DNF_PACKAGES="python3-devel python3-virtualenv curl git ffmpeg libsndfile portaudio-devel yad qt6-qtwebengine qt6-qtbase-gui mesa-libEGL libglvnd-glx libxkbcommon xcb-util-cursor"
PACMAN_PACKAGES="python-virtualenv python-pip curl git ffmpeg libsndfile portaudio yad qt6-webengine qt6-base libglvnd libxkbcommon xcb-util-cursor"
ZYPPER_PACKAGES="python3-devel python3-virtualenv curl git ffmpeg libsndfile1 portaudio-devel yad libQt6WebEngine6 libQt6Gui6 libEGL1 libGL1 libxkbcommon0 libxcb-cursor0"
...
FK_LIBRARY_DIR=$INSTALL_DIR/core/library
FK_MODELS_DIR=$INSTALL_DIR/core/models
QT_QPA_PLATFORM=xcb
QTWEBENGINE_CHROMIUM_FLAGS=--no-sandbox --disable-gpu-sandbox --disable-dev-shm-usage --disable-http-cache
EOF
...
# Загружаем все переменные из .env.cache (включая UV_CACHE_DIR, TORCH_HOME, HF_HOME, QT_*)
...
# Передаём управление основному скрипту запуска в core/
